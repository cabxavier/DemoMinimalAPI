...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Developed by César Augusto Barbosa Xavier",
        Contact = new OpenApiContact { Name = "César Augusto Barbosa Xavier", Email = "cesaraugustobarbosaxavier@gmail.com" },
...
void MapActions(WebApplication app)
{
        ...
        Fornecedor fornecedor) =>
    {
        ...
        if (fornecedorBanco == null) return Results.NoContent();
        ...
        MinimalContextDb context) =>
    {
        ...
        if (fornecedor == null) return Results.NoContent();
